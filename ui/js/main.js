$(function(){
                ...
                $.post(`https://${GetParentResourceName()}/getReports`, function(Reports){
                    ...
                    for (let i = 0; i < Reports.length; i++){
                        ...
                        <div class="report" data-reportid="${report.reportId}">
                            ...
                            <div class="asister">${report.concluded ? report.concludedby : "Ingen"}</div>
                            <div class="category-a">${report.category}</div>
                            <div class="action">
                                <div class="btn view">Vis</div>
                            </div>
                        </div>
                        `      
                    }
                    ...
                    $(".action .view").click(function(){
                        for (let i = 0; i < reports.length; i++){
                            if (reports[i].reportId == $(this).parent().parent().data("reportid")){
                                ...
                                $(".header .title").text("Rapport #" + reports[i].reportId)
                                $(".header .subtitle").text("Avsender er " + reports[i].reporter.name + ". ID " + reports[i].reporter.id)
    ...
    $("#categoryBtn").click(function(){
        ...
        setTimeout(() => {
            ...
            $(".header .subtitle").text("Hva vil du si?")
            backType = "reporting"
        }, 100)
    })
    ...
    $("#sendBtn").click(function(){
        ...
        setTimeout(() => {
            ...
            $(".header .subtitle").text("Vennligst velg årsaken for rapporteringen.")
            $("#sendBtn").hide()
            $("#categoryBtn").show()
    ...
    <div class="text-box-wrapper">
        <div class="subject text-box">
            <div class="title">Emne</div>
            <input type="text" placeholder="Skriv inn emnet her" id="subject">
        </div>
        <div class="message text-box">
            <div class="title">Melding</div>
            <textarea placeholder="Skriv inn meldingen her" id="message"></textarea>
        </div>
    </div>
    `
    ...
    function openReportMenu(){
        ...
        $(".header .title").text("TSRP | Rapport system")
        $(".header .subtitle").text("Fyll ut din rapport nedenfor!")
    ...
    function openAdminMenu(){
        ...
        $(".header .title").text("TSRP | Rapport system")
        $(".header .subtitle").text("De siste rapportene vises nedenfor!")
